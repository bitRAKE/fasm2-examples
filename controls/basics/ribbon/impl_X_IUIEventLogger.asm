...
; Event reporting seems very restricted.
...
.fail_setlog:
	← "Error:",27,'[31m'," Failed to set the event logger [prior to IUIFramework::LoadUI].",27,'[m',10
	__fastfail 1
...
QueryInterface:	; (IUIEventLogger* this, REFIID iid, void** ppv) HRESULT
	lea rax, [.iids]
